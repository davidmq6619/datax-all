...
public interface EtlConst {
    ...
    String alias1 = "低回声结节:低回声,低回声区:低回声,低回声:低回声,弱回声结节:低回声,弱回声:低回声,弱回声区:低回声,高回声结节:高回声,高回声:高回声,高回声区:高回声,稍强回声结节:高回声,强回声结节:高回声,强回声区:高回声,强回声:高回声,等回声:等回声,等回声结节:等回声,等回声区:等回声,呈等回声:等回声,无回声结节:无回声,无回声区:无回声,无回声:无回声,混合回声区:混合回声,混合回声结节:混合回声,无回声:无回声,混合回声:混合回声,混合性回声:混合回声";
    ...
    String keyLevelJson="[{\n" +
            ...
            "},{\n" +
            "  \"level\":2,\n" +
            "  \"keywords\":[\"等回声\",\"实性\",\"混合回声\",\"囊实\",\"无回声\",\"囊性\"]\n" +
            "}]";
